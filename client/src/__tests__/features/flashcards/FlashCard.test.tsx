...
describe('FlashCard', () => {
  ...
  it('renders in edit mode', () => {
    render(<FlashCard card={flashCardData} editMode={true} onUpdate={vi.fn()} onDelete={vi.fn()} />);
  ...
  it('calls onDelete when delete button clicked in editMode', () => {
    ...
    render(<FlashCard card={flashCardData} editMode={true} onUpdate={vi.fn()} onDelete={onDelete} />);
  ...
  it('calls onUpdate on blur when values changed in editMode', async () => {
    ...
    render(<FlashCard card={flashCardData} editMode={true} onUpdate={onUpdate} onDelete={vi.fn()} />);
    const textareas = screen.getAllByRole('textbox');
