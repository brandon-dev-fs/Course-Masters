...
export default function HeroSection({ loggedIn, userName = '' }: HeroSectionProps) {
	if (loggedIn) {
		return (
			<section
				aria-label="Hero"
				className="w-full py-6 px-5 bg-[#0a0a16] md:py-8 md:px-6"
			>
	...
	return (
		<section
			aria-label="Hero"
			className="w-full py-20 px-6 bg-[#0a0a16]"
		>
			<div className="max-w-7xl mx-auto grid grid-cols-1 gap-12 items-center md:grid-cols-2">
				...
				<div className="flex flex-col justify-center text-center md:text-left">
					...
					<div className="flex flex-col gap-3 w-full sm:flex-row sm:w-auto">
						<Link
							to="/register"
							className="inline-flex items-center justify-center gap-2 font-semibold transition-all px-6 py-3 text-base rounded-2xl bg-primary text-white shadow-warm-sm hover:brightness-110 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a16]"
						>
							Get Started
						</Link>
						<Link
							to="/login"
							className="inline-flex items-center justify-center gap-2 font-semibold transition-all px-6 py-3 text-base rounded-2xl border border-white/60 bg-transparent text-white hover:bg-white/10 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white focus-visible:ring-offset-2 focus-visible:ring-offset-[#0a0a16]"
						>
							Sign In
						</Link>
					</div>
